...
patterns = ["/", "\\\\", "|", "-", "+", "xxx", "o", "O", ".", "*"]
# 输入统计数据
periods = ('20', '40', '60', '80', '100')
eta_IC = [93,150,220,280,351]
gpa_IC = [70,116,175,234,283]
...
plt.bar(index1, height=eta_IC, width=bar_width, edgecolor='black',
        color='#D57A66', label='未预分区', hatch=patterns[3])
plt.bar(index2, height=gpa_IC, width=bar_width, edgecolor='black',
        color='#6D9BA8', label='预分区', hatch=patterns[1])
...
plt.xlabel("数据量 (%)", yFont)
plt.ylabel('存储时间 (s)', yFont)  # 纵坐标轴标题
plt.tick_params(labelsize=tickSize)
...
# 输入统计数据
periods = ('20', '40', '60', '80', '100')
eta_IC = [51,90,124,155,187]
gpa_IC = [40, 71, 101, 135, 151]
